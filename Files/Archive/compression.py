...
class _LZW(object):
    ...
    def decode(self):
        ...
        array = [struct.unpack(self._b[self._bit], s)[0] for s in self._chunks(self._input, int(self.__bit/8))]
